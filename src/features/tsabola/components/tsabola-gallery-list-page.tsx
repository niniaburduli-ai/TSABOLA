    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-16 w-full">
        ...
        <div className="text-center mb-16">
          <p className="text-xs font-semibold tracking-widest uppercase text-wine mb-3">{r(t.gallery.subtitle)}</p>
          <h1 className="font-display text-4xl sm:text-5xl font-bold text-charcoal dark:text-cream">{r(t.gallery.title)}</h1>
