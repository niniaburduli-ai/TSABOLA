...
describe('TsabolaWineCatalog', () => {
  it('renders all wines', () => {
    ...
    expect(screen.getByText('ცაბო ჩინებული')).toBeInTheDocument()
    expect(screen.getByText('ცაბო დანახარული')).toBeInTheDocument()
  })
  ...
  it('opens lightbox when wine image is clicked', () => {
    render(<TsabolaWineCatalog />)
    const buttons = screen.getAllByRole('button', { name: /ცაბო ჩინებული/i })
  ...
  it('closes lightbox when close button is clicked', () => {
    render(<TsabolaWineCatalog />)
    const imageButtons = screen.getAllByRole('button', { name: /ცაბო ჩინებული/i })
